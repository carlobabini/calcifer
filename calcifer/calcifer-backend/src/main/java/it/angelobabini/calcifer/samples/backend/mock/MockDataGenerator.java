package it.angelobabini.calcifer.samples.backend.mock;
...
import it.angelobabini.calcifer.samples.backend.data.Availability;
import it.angelobabini.calcifer.samples.backend.data.Category;
