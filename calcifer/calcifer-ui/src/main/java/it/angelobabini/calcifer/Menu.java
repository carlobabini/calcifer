...
public class Menu extends CssLayout {
	private static final long serialVersionUID = 887930470674496351L;
	...
	public Menu(Navigator navigator) {
		...
		top.setSpacing(true);
		Label title = new Label("calcifer");
		...
		logoutMenu.addItem("Logout", FontAwesome.SIGN_OUT, new Command() {
			private static final long serialVersionUID = -4341353346173719217L;
		...
		final Button showMenu = new Button("Menu", new ClickListener() {
			private static final long serialVersionUID = -504941716214282118L;
	...
	private void createViewButton(final String name, String caption, Resource icon) {
		Button button = new Button(caption, new ClickListener() {
			private static final long serialVersionUID = -5000705256591234345L;
