      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setClass("it.angelobabini.calcifer.samples.ResetButtonForTextField", it.angelobabini.calcifer.client.samples.ResetButtonForTextFieldConnector.class);
          ...
          private void load1() {
            ...
            store.setConstructor(it.angelobabini.calcifer.client.samples.ResetButtonForTextFieldConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(it.angelobabini.calcifer.client.samples.ResetButtonForTextFieldConnector.class);
              }
            });
            ...
            store.setReturnType(it.angelobabini.calcifer.client.samples.ResetButtonForTextFieldConnector.class, "getState", new Type(com.vaadin.shared.communication.SharedState.class));
