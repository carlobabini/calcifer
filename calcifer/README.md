...
- calcifer-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- calcifer-ui: main application module, development time
- calcifer-production: module that produces a production mode WAR for deployment
